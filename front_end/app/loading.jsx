    ...
    const processImageWithBackend = async () => {
      try {
        ...
        try {
          ...
          const response = await fetch('http://10.50.8.203:3000/api/crop/save', {
            method: 'POST',
            body: formData,
            headers: {
          ...
          console.log("inside backend error catch");
          console.error("Error calling backend API; setting dummy result:", error);
