...
const Progress = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      const response = await fetch("http://10.50.8.203:3000/getReports"); // Replace with your actual backend URL
  ...
  const handleTilePress = async (reportId, time_stamp) => {
    ...
    try {
      ...
      const response = await fetch(`http://10.50.8.203:3000/getSingleReport/${reportId}`, {
        method: 'GET',
      })
